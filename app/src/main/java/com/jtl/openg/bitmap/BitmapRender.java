...
//    private static final String FRAGMENT_SHADER_NAME = "shaders/point_circle.frag";
    ...
    private void initData(Context context) {
        try {
            mBitmap = BitmapFactory.decodeStream(context.getAssets().open("model/nba.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    protected void onDraw() {
        ...
        GLES20.glVertexAttribPointer(a_Position, 2, GL_FLOAT, true, 0, mVertexCoord);
        GLES20.glVertexAttribPointer(a_TexCoord, 2, GL_FLOAT, true, 0, mTextureCoord);
